...
RabbitMQ is an open-source message-broker software that originally implemented the AMQP protocol and supports multiple messaging protocols.

### Importance

- Leading message broker
